...
//-- Movea patch for android -- start
// #include <cmath>
#include <math.h>
//-- Movea patch for android -- end

//-- Movea patch for android-x86-api18 -- start
using namespace std;
//-- Movea patch for android-x86-api18 -- end
...
{
	//-- Movea patch for android -- start
	// apparently android cannot find std::isinf ...
...
{
	//-- Movea patch for android -- start
	// apparently android cannot find std::isnan ...
